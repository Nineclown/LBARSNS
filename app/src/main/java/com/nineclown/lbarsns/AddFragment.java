...
public final class AddFragment extends Fragment
     ...
     */
    public static AddFragment newInstance(CropDemoPreset demoPreset) {
    ...
    public void updateCurrentCropViewOptions() {
        ...
        ((AddActivity) getActivity()).setCurrentOptions(options);
    }
    ...
    public View onCreateView(
        ...
        switch (mDemoPreset) {
            case RECT:
                rootView = inflater.inflate(R.layout.fragment_add_rect, container, false);
                break;
            case CIRCULAR:
                rootView = inflater.inflate(R.layout.fragment_add_oval, container, false);
                break;
            case CUSTOMIZED_OVERLAY:
                rootView = inflater.inflate(R.layout.fragment_add_customized, container, false);
                break;
            case MIN_MAX_OVERRIDE:
                rootView = inflater.inflate(R.layout.fragment_add_min_max, container, false);
                break;
            case SCALE_CENTER_INSIDE:
                rootView = inflater.inflate(R.layout.fragment_add_scale_center, container, false);
                break;
            case CUSTOM:
                rootView = inflater.inflate(R.layout.fragment_add_rect, container, false);
                break;
